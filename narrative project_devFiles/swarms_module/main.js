...
Promise.all([
  ...
  d3.json("./ALL_countries_covid_v2.json", d3.autotype),
...
mentionDot_plot.append("text")
  ...
  var ment_dots = mentionDot_plot
      ...
      .join(enter =>
        ...
        .attr("fill", function(d,i) { if (state.selectedPolicyTypes.includes(d.event_type)) {return colors[d["event_type"]];}
        ...
        .attr("opacity", function(d,i) { if (state.selectedPolicyTypes.includes(d.event_type)) {return 0.8;}
        else {return 0.25;}
        })
        .attr("r", 0)
        ...
        .call(enter =>
          ...
          .attr("r", function(d,i) { if (state.selectedPolicyTypes.includes(d.event_type)) {return 7;}
            else {return 3.5;}
          })
