...
legend_svg.append("g")
  ...
  /*swarm.append("text")
  .attr("transform",`translate(${xScale(-30)},${margins.top-60})`)
  .style("font","16px sans-serif")
  .style("font-family","Avenir")
  .text("How long did it take governments to announce new types of policy responses?");// adding a title to the plot
 */
