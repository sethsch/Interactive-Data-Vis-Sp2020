...
/// init and scales for the stacked chart
    ...
    circ_scale = d3.scale.sqrt()
    .domain([0,d3.max(state.mentTotals,d=>d.term_reg_tot_ment)])
    .range([0,40]);
...
function drawStacked () {
    ...
    var ment_dots = stacked_plot.selectAll(".ment-dot")
        .data(stackedFiltered)
        .join(enter =>
                enter
                .append("circle")
                .attr("class","ment-dot")
                ...
                .attr("opacity",0)
                .attr("cy", d=> yScale_stacked(d.obs_region))
                .attr("r", 0)
                .call(enter =>
                    enter
                    .transition()
                    .delay(d=>xScale_stacked(d.year)*1.4)
                    .duration(1000)
                    .attr("r", circ_scale(d.mentions))
                    .attr("opacity",0.8)),
            exit =>
                exit
                .call(exit =>
