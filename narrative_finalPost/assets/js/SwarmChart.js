...
class SwarmChart {
    ...
    draw(state,setGlobalState,policyType,div_name) {
        ...
        const policyText = this.svg.append("text")
            ...
            .attr("transform",`translate(${this.margins.left},${this.margins.top-15})`)
            .text(policyType)
            //.call(this.wrap,240)
    ...
    .on('tick', function() {
        ...
        u.join(enter=>
            ...
            .attr('r',function(d) {
                if (!state.selectedPolicies.includes(d.policy_id)) {return 0;}
                else if ( state.selectedRegion !== " All" && state.selectedCountry !== " All") {
        ...
        .on("mouseover", function (d) {
            ...
            var html  =  "<b>" + d.country + "</b><br/>" +
                    ...
                    "<b> New cases: </b>" + location_newcases+ " <b>Cases to-date: </b>" + location_totalcases+ "<br/>"+
                    "<b> New deaths: </b>" + location_newdeaths+ " <b>Deaths to-date: </b>" + location_totaldeaths + "<br/>"+
